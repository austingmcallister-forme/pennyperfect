  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">PennyPerfect Dashboard</h1>
          <p className="mt-2 text-gray-600">
            Auto-test price endings with switchback experiments
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Price Bands</h2>
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Run switchback tests to find optimal price endings
              </p>
              <div className="flex space-x-3">
                <Link
                  href="/experiments"
        ...
        <div className="mt-8 bg-white rounded-lg shadow">
          <div className="p-6">
            ...
            <div className="text-center py-8 text-gray-500">
              No recent activity yet. Start by creating a price band and experiment.
            </div>
          </div>
        </div>
      </div>
